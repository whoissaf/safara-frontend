      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Row(
                children: [
                  ...
                  const Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Traveler', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900)), SizedBox(height: 4), Text('traveler@safara.com', style: TextStyle(fontSize: 14))])),
                ],
              ),
            ),
            ...
            SizedBox(width: double.infinity, height: 50, child: ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: NeoColors.red, foregroundColor: NeoColors.surface), onPressed: () {}, child: const Text('LOGOUT'))),
          ],
        ),
      ),
    );
